...
<?php include('db_connections/bin5_bin6/db_datadelete3.php'); ?>

<!-- Db_status connection -->
<?php include('db_connections/bin5_bin6/db_status3.php'); ?>
...
<head>
    ...
    <script>
        function updateProgressBars() {
            $.ajax({
                url: 'db_connections/bin5_bin6/get_bin_data3.php',
                type: 'GET',
                dataType: 'json',
    ...
    <script>
        function refreshButtonColors() {
            $.ajax({
                url: 'db_connections/bin5_bin6/get_button_colors3.php',
                type: 'GET',
                dataType: 'json',
                success: function (data) {
...
<body >
    <div class="content">
        ...
        <?php
            ...
            $query = "SELECT location3 FROM thesis_data3";
        ...
        <h3 class="mb-5" style="text-align: center; padding-top: 10px; margin: 0; position: relative;">
            Location: &nbsp;&nbsp;<u id="displayedLocation"><?php echo $location3; ?></u>
                    ...
                    <form id="editForm"> 
                        <div class="modal-body">               
                            <div class="form-group">
                                ...
                                <input type="text" name="location3" id="location3" class="form-control"
        ...
        <div class="container-fluid pt-6 px-4" style="margin-top:35px;">
            ...
            <div style="margin-left: 25px; margin-right: 25px; text-align: center; margin-top:-20px;"> 
                    ...
                    <script>
                        $(document).ready(function () {
                            var table = $('#trash-bin1').DataTable({
                                ajax: 'db_connections/bin5_bin6/db_dashboardv3.php',
                                columns: [
                                    { data: 'timestamp_date'},
                                    { data: 'timestamp_time'},
                                    { data: 'trash_type1'},
                ...
                <div class="trash-table"><h3>Trash Bin 6</h3></div>            
...
<script>
    $(document).ready(function () {
        $('.location-btn').on('click', function () {
            ...
            $('#location3').val(location);
            $('#editmodal').modal('show');
        });

        $('#savelocationbtn').on('click', function () {
            var newLocation = $('#location3').val();

            if (newLocation) {
                $.ajax({
                    type: "POST",
                    url: "db_connections/bin5_bin6/db_location3.php",
