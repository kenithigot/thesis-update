...
$sql_bin1 = "SELECT bin5 FROM thesis_data3 ORDER BY data_id DESC LIMIT 1";
$result_bin1 = $conn->query($sql_bin1);

$sql_bin2 = "SELECT bin6 FROM thesis_data3 ORDER BY data_id DESC LIMIT 1";
