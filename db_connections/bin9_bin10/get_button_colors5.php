...
$sql_bin1 = "SELECT bin9 FROM thesis_data5 ORDER BY data_id DESC LIMIT 1";
$result_bin1 = $conn->query($sql_bin1);

$sql_bin2 = "SELECT bin10 FROM thesis_data5 ORDER BY data_id DESC LIMIT 1";
