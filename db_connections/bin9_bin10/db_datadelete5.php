        ...
        echo '<script>
                swal({
                    ...
                    if (willDelete) {
                        ...
                        xhr.open("POST", "db_connections/bin9_bin10/delete_data5.php", true);  // PHP file or endpoint for handling the deletion
                        ...
                        xhr.onreadystatechange = function() {
                            if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
                                swal("Success", "Data deleted successfully!", "success")
                                    .then(() => {
                                        setTimeout(function() {
                                            window.location.href = "dashboardv5.php"; // Reload the page after 2 seconds
