        ...
        echo '<script>
                swal({
                    ...
                    if (willDelete) {
                        ...
                        xhr.open("POST", "db_connections/bin1_bin2/delete_data.php", true);  // PHP file or endpoint for handling the deletion
                        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                        xhr.onreadystatechange = function() {
                            if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
                                swal("Success", "Data deleted successfully!", "success")
                                    .then(() => {
                                        window.location.href = "dashboard.php"; // Reload the page
                                    });
