...
$sql_bin1 = "SELECT bin1 FROM thesis_data ORDER BY data_id DESC LIMIT 1";
$result_bin1 = $conn->query($sql_bin1);

$sql_bin2 = "SELECT bin2 FROM thesis_data ORDER BY data_id DESC LIMIT 1";
