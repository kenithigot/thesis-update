...
$sql_bin1 = "SELECT bin3 FROM thesis_data2 ORDER BY data_id DESC LIMIT 1";
$result_bin1 = $conn->query($sql_bin1);

$sql_bin2 = "SELECT bin4 FROM thesis_data2 ORDER BY data_id DESC LIMIT 1";
